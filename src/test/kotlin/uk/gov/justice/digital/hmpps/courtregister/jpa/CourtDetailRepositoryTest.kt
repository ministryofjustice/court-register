...
class CourtDetailRepositoryTest {
  ...
  @Autowired
  lateinit var typeOfCourtRepository: TypeOfCourtRepository
  ...
  fun `should insert court`() {
    val crownCourtType = typeOfCourtRepository.findById("CRN").orElseThrow()

    val court = CourtDetail("SHFCRT", "Sheffield Court", "A Court in Sheffield", crownCourtType, true)
